...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, expected: Dict,
        ...
        """Test client org method
        Args:
                org (str): _description_
                expected (Dict): _description_
                mocked_fn (MagicMock): _description_
        """
    ...
    def test_public_repos(self, mock_get_json: MagicMock) -> None:
        """Test client method
        Args:
                mock_get_json (MagicMock): mocked function
        """
        test_payload = {
            'repos_url': "https://api.github.com/users/google/repos",
            'repos': [
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self) -> None:
        """Test public repos client method
        """
        self.assertEqual(
            GithubOrgClient("google").public_repos(),
            self.expected_repos,
